...
# Logs
ssh -t -t $EC2_OAE_APP1 "cd /usr/local/sakaioae; sudo tar -cf /tmp/logs.tar gc.log Perf4J*; cd /var/log/sakaioae; sudo tar -rf /tmp/logs.tar error.log; sudo gzip -f /tmp/logs.tar"
